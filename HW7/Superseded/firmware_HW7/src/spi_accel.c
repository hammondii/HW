...
//
//    while(_CP0_GET_COUNT()< LOADMAX/5){
//        _nop();
//    }
...
//
//    /*Testing: Delete after working*/
//    sprintf(mbuff,"Values (X:%d, Y:%d, Z:%d)",accels[0],accels[1],accels[2]);
////    sprintf(accmouse, "%d%d", accels[0],accels[1]);
//    display_clear();
//    OLED_WRITE(0,0, mbuff);
//
//    return (&accels);
//}
