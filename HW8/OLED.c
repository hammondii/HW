...
void OLED_WRITE(int row1, int col1, volatile unsigned char * input){  //Make this char *input
...
void OLED_SNAKE(unsigned char * xyvalues ){  //Make this char *input
    ...
    int yvalue = ((int) ((float) ((float)xyvalues[1]/YMAX) * YSCALE));
   if(xvalue >0) temp = 1;
   else if(xvalue<0) temp =2;
   else temp =0;

//   Debugging Section
//   sprintf(buffsnake,'xvaule = %d xyvalue[0] = %d',xvalue,xyvalues[0]);
//   OLED_WRITE(40,0,pbuffsnake);
   //OLED_WRITE(40,0,(unsigned char *) buffsnake);
